// Seed script that handles RLS properly
...
async function seedDestinations() {
  ...
  try {
    // Use RPC function to bypass RLS for seeding
    const { data, error } = await supabase.rpc('seed_destinations', {
      destinations_data: testDestinations
    });
    ...
    console.log('✅ Successfully seeded destinations via RPC');
